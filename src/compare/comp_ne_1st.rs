...
macro_rules! generic_compare {
    ($fname:ident, $type:ty) => {
        ...
        pub fn $fname<'py>(
            ...
            let length: i64 = ends_array
                .iter()
                .zip(starts_array.iter())
                .map(|(e, s)| e - s)
                .sum();
...
generic_compare!(compare_start_end_ne_1st_float64, f64);
generic_compare!(compare_start_end_ne_1st_float32, f32);
