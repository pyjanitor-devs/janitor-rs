...
pub fn binary_search_le_core<T: PartialOrd + Copy>(
    left: ArrayView1<T>,
    right: ArrayView1<T>,
...
macro_rules! bin_search {
    ($fname:ident, $type:ty) => {
        ...
        pub fn $fname<'py>(
            ...
            let result = binary_search_le_core(
                left.as_array(),
                right.as_array(),
                starts.as_array(),
                ends.as_array(),
...
bin_search!(binary_search_le_int64, i64);
bin_search!(binary_search_le_int32, i32);
bin_search!(binary_search_le_int16, i16);
bin_search!(binary_search_le_int8, i8);
bin_search!(binary_search_le_uint64, u64);
bin_search!(binary_search_le_uint32, u32);
bin_search!(binary_search_le_uint16, u16);
...
mod tests {
    ...
    fn both_bounds_negative_but_start_less_than_end_returns_minus_one_not_a_panic() {
        ...
        let got = binary_search_le_core(left.view(), right.view(), starts.view(), ends.view());
