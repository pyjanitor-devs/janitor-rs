...
fn array_compare_int64(
    ...
    let mut counts_array = Array1::<i64>::zeros(array_counts.len());
    let mut n: usize = 0;
    let mut right_val: i64;
    let mut compare: bool;
    let mut total: i64 = 0;
    let zipped = izip!(left.into_iter(), ends.into_iter(), array_counts.into_iter());
    for (position, (left_val, end, count_)) in zipped.enumerate() {
...
#[pyfunction(name = "compare_end_int64")]
pub fn compare_int64<'py>(
    ...
    array_counts: PyReadonlyArray1<'py, i64>,
    ...
    let array_counts = array_counts.as_array();
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_int64(left, right, ends, array_counts, matches, op);
    (
...
#[pyfunction(name = "compare_end_int32")]
pub fn compare_int32<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_int32(left, right, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
#[pyfunction(name = "compare_end_int16")]
pub fn compare_int16<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_int16(left, right, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
#[pyfunction(name = "compare_end_int8")]
pub fn compare_int8<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_int8(left, right, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
#[pyfunction(name = "compare_end_float32")]
pub fn compare_float32<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_float32(left, right, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
#[pyfunction(name = "compare_end_float64")]
pub fn compare_float64<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_float64(left, right, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
#[pyfunction(name = "compare_end_uint64")]
pub fn compare_uint64<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_uint64(left, right, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
#[pyfunction(name = "compare_end_uint32")]
pub fn compare_uint32<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_uint32(left, right, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
#[pyfunction(name = "compare_end_uint16")]
pub fn compare_uint16<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_uint16(left, right, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
#[pyfunction(name = "compare_end_uint8")]
pub fn compare_uint8<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_uint8(left, right, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
