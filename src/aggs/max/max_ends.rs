...
pub(crate) fn register(m: &Bound<'_, PyModule>) -> PyResult<()> {
    m.add_function(wrap_pyfunction!(compute_max_end_uint64, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_end_uint32, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_end_uint16, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_end_uint8, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_end_int64, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_end_int32, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_end_int16, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_end_int8, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_end_f32, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_end_f64, m)?)?;
    Ok(())
}
