...
pub(crate) fn register(m: &Bound<'_, PyModule>) -> PyResult<()> {
    m.add_function(wrap_pyfunction!(compute_max_positions_uint64, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_positions_uint32, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_positions_uint16, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_positions_uint8, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_positions_int64, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_positions_int32, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_positions_int16, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_positions_int8, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_positions_f32, m)?)?;
    m.add_function(wrap_pyfunction!(compute_max_positions_f64, m)?)?;
    Ok(())
}
