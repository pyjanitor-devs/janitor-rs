...
#[pyfunction(name = "compute_sum_rev_start_match_int64")]
pub fn compute_int64<'py>(
    ...
    let (indexers, result) = array_compute_int64(arr, starts, counts, index, matches, booleans);

    (indexers.into_pyarray(py), result.into_pyarray(py))
}

#[pyfunction(name = "compute_sum_rev_start_match_int32")]
pub fn compute_int32<'py>(
    ...
    let index = index.as_array();
    let booleans = booleans.as_array();
    let (indexers, result) = array_compute_int32(arr, starts, counts, index, matches, booleans);

    (indexers.into_pyarray(py), result.into_pyarray(py))
}

#[pyfunction(name = "compute_sum_rev_start_match_int16")]
pub fn compute_int16<'py>(
    ...
    let index = index.as_array();
    let booleans = booleans.as_array();
    let (indexers, result) = array_compute_int16(arr, starts, counts, index, matches, booleans);

    (indexers.into_pyarray(py), result.into_pyarray(py))
}

#[pyfunction(name = "compute_sum_rev_start_match_int8")]
pub fn compute_int8<'py>(
    ...
    let index = index.as_array();
    let booleans = booleans.as_array();
    let (indexers, result) = array_compute_int8(arr, starts, counts, index, matches, booleans);

    (indexers.into_pyarray(py), result.into_pyarray(py))
}

#[pyfunction(name = "compute_sum_rev_start_match_uint64")]
pub fn compute_uint64<'py>(
    ...
    let index = index.as_array();
    let booleans = booleans.as_array();
    let (indexers, result) = array_compute_uint64(arr, starts, counts, index, matches, booleans);

    (indexers.into_pyarray(py), result.into_pyarray(py))
}

#[pyfunction(name = "compute_sum_rev_start_match_uint32")]
pub fn compute_uint32<'py>(
    ...
    let index = index.as_array();
    let booleans = booleans.as_array();
    let (indexers, result) = array_compute_uint32(arr, starts, counts, index, matches, booleans);

    (indexers.into_pyarray(py), result.into_pyarray(py))
}

#[pyfunction(name = "compute_sum_rev_start_match_uint16")]
pub fn compute_uint16<'py>(
    ...
    let index = index.as_array();
    let booleans = booleans.as_array();
    let (indexers, result) = array_compute_uint16(arr, starts, counts, index, matches, booleans);

    (indexers.into_pyarray(py), result.into_pyarray(py))
}

#[pyfunction(name = "compute_sum_rev_start_match_uint8")]
pub fn compute_uint8<'py>(
    ...
    let index = index.as_array();
    let booleans = booleans.as_array();
    let (indexers, result) = array_compute_uint8(arr, starts, counts, index, matches, booleans);
...
#[pyfunction(name = "compute_sum_rev_start_match_f32")]
pub fn compute_f32<'py>(
    ...
    let index = index.as_array();
    let booleans = booleans.as_array();
    let (indexers, result) = array_compute_f32(arr, starts, counts, index, matches, booleans);

    (indexers.into_pyarray(py), result.into_pyarray(py))
}

#[pyfunction(name = "compute_sum_rev_start_match_f64")]
pub fn compute_f64<'py>(
    ...
    let index = index.as_array();
    let booleans = booleans.as_array();
    let (indexers, result) = array_compute_f64(arr, starts, counts, index, matches, booleans);
