...
compute_ints!(compute_prod_rev_start_end_match_int64, i64);
compute_ints!(compute_prod_rev_start_end_match_int32, i32);
compute_ints!(compute_prod_rev_start_end_match_int16, i16);
compute_ints!(compute_prod_rev_start_end_match_int8, i8);
compute_ints!(compute_prod_rev_start_end_match_uint64, u64);
compute_ints!(compute_prod_rev_start_end_match_uint32, u32);
compute_ints!(compute_prod_rev_start_end_match_uint16, u16);
compute_ints!(compute_prod_rev_start_end_match_uint8, u8);
...
mod correctness_tests {
    ...
    fn touched_row_positions_are_emitted_ascending_with_products() {
        ...
        Python::attach(|py| {
            ...
            // (tape width 2) -- total tape width 4, all matching.
            // Position 4 gets both rows' values: 2*5=10.
            ...
            let (indexers, result) = compute_prod_rev_start_end_match_int64(
                py,
                arr.readonly(),
                starts.readonly(),
                ends.readonly(),
            ...
            assert_eq!(result.readonly().to_vec().unwrap(), vec![2, 10, 5]);
        });
    }
}
