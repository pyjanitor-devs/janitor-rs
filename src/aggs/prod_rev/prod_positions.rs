...
mod correctness_tests {
    ...
    use super::compute_prod_rev_positions_int64;
    ...
    fn touched_row_positions_are_emitted_ascending_with_products() {
        ...
        Python::attach(|py| {
            ...
            // {6, 9}. Position 6 gets both rows' values: 4*5=20.
            ...
            let (indexers, result) = compute_prod_rev_positions_int64(
                py,
                arr.readonly(),
                starts.readonly(),
                ends.readonly(),
            ...
            assert_eq!(result.readonly().to_vec().unwrap(), vec![4, 20, 5]);
        });
    }
}
