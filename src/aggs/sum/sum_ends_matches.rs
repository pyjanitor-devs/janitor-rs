...
generic_compute_ints!(compute_sum_end_match_int64, i64);
generic_compute_ints!(compute_sum_end_match_int32, i32);
generic_compute_ints!(compute_sum_end_match_int16, i16);
generic_compute_ints!(compute_sum_end_match_int8, i8);
generic_compute_ints!(compute_sum_end_match_uint64, u64);
generic_compute_ints!(compute_sum_end_match_uint32, u32);
generic_compute_ints!(compute_sum_end_match_uint16, u16);
