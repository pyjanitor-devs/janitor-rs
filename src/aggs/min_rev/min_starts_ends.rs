...
mod correctness_tests {
    ...
    use super::compute_min_rev_start_end_int64;
    ...
    fn touched_row_positions_are_emitted_ascending_with_winning_row_index() {
        ...
        Python::attach(|py| {
            ...
            // {4, 1}, row1 (1..3) reaches index[1..3] = {1, 8}. Row0's
            // value (3) beats row1's (7) at the shared position 1.
            ...
            let (indexers, result) = compute_min_rev_start_end_int64(
                py,
                arr.readonly(),
                starts.readonly(),
                ends.readonly(),
