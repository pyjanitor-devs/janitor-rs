...
pub(crate) fn register(m: &Bound<'_, PyModule>) -> PyResult<()> {
    m.add_function(wrap_pyfunction!(compute_min_start_match_uint64, m)?)?;
    m.add_function(wrap_pyfunction!(compute_min_start_match_uint32, m)?)?;
    m.add_function(wrap_pyfunction!(compute_min_start_match_uint16, m)?)?;
    m.add_function(wrap_pyfunction!(compute_min_start_match_uint8, m)?)?;
    m.add_function(wrap_pyfunction!(compute_min_start_match_int64, m)?)?;
    m.add_function(wrap_pyfunction!(compute_min_start_match_int32, m)?)?;
    m.add_function(wrap_pyfunction!(compute_min_start_match_int16, m)?)?;
    m.add_function(wrap_pyfunction!(compute_min_start_match_int8, m)?)?;
    m.add_function(wrap_pyfunction!(compute_min_start_match_f32, m)?)?;
    m.add_function(wrap_pyfunction!(compute_min_start_match_f64, m)?)?;
    Ok(())
}
