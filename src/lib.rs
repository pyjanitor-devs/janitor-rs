...
mod comp_ne;
mod comp_ne_1st;
mod comp_ne_1st_ends;
mod comp_ne_1st_starts;
mod comp_ne_ends;
mod comp_ne_starts;
mod comp_starts;
mod index_builder;
...
fn janitor_rs(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_uint64, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_uint32, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_uint16, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_uint8, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_int64, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_int32, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_int16, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_int8, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_float32, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_starts::compare_float64, m)?)?;

    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_uint64, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_uint32, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_uint16, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_uint8, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_int64, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_int32, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_int16, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_int8, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_float32, m)?)?;
    m.add_function(wrap_pyfunction!(comp_ne_1st_ends::compare_float64, m)?)?;
