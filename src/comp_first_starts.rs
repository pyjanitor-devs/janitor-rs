...
fn array_compare_int64(
    ...
    let zipped = izip!(left.into_iter(), starts.into_iter(),);
...
pub fn compare_int64<'py>(
    ...
    let (result, counts_array, total) = array_compare_int64(left, right, starts, length, op);
    (
...
pub fn compare_int32<'py>(
    ...
    let (result, counts_array, total) = array_compare_int32(left, right, starts, length, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_int16<'py>(
    ...
    let (result, counts_array, total) = array_compare_int16(left, right, starts, length, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_int8<'py>(
    ...
    let (result, counts_array, total) = array_compare_int8(left, right, starts, length, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_float32<'py>(
    ...
    let (result, counts_array, total) = array_compare_float32(left, right, starts, length, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_float64<'py>(
    ...
    let (result, counts_array, total) = array_compare_float64(left, right, starts, length, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_uint64<'py>(
    ...
    let (result, counts_array, total) = array_compare_uint64(left, right, starts, length, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_uint32<'py>(
    ...
    let (result, counts_array, total) = array_compare_uint32(left, right, starts, length, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_uint16<'py>(
    ...
    let (result, counts_array, total) = array_compare_uint16(left, right, starts, length, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_uint8<'py>(
    ...
    let (result, counts_array, total) = array_compare_uint8(left, right, starts, length, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
