...
fn array_compare_int64(
    ...
    let zipped = izip!(
        ...
        starts.into_iter(),
        ends.into_iter(),
        array_counts.into_iter()
    );
    for (position, (left_val, start, end, count_)) in zipped.enumerate() {
...
pub fn compare_int64<'py>(
    ...
    let (result, counts_array, total) =
        array_compare_int64(left, right, starts, ends, array_counts, matches, op);
    (
...
pub fn compare_int32<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_int32(left, right, starts, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_int16<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_int16(left, right, starts, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_int8<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_int8(left, right, starts, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_float32<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_float32(left, right, starts, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_float64<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_float64(left, right, starts, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_uint64<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_uint64(left, right, starts, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_uint32<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_uint32(left, right, starts, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_uint16<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_uint16(left, right, starts, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
...
pub fn compare_uint8<'py>(
    ...
    let matches = matches.as_array();
    let (result, counts_array, total) =
        array_compare_uint8(left, right, starts, ends, array_counts, matches, op);
    (
        result.into_pyarray(py),
        counts_array.into_pyarray(py),
        total,
